...
import com.sandip.blog.payloads.ApiResponse;
...
//	        //String message = "Duplicate entry in the database: " + ex.getMessage();
//		 String message = "User Already Registred with this email ";
//	        ApiResponse apiResponse = new ApiResponse(message, false);
